...
export class CompanyServiceApi extends BaseLoopBackApi {
   ...
   *
   * @param {any} id CompanyService id
   *
   ...
   * </em>
   */
  public getPhotoCompanyService(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/CompanyServices/:id/photo/companyService";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
