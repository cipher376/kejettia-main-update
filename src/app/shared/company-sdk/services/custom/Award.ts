...
/**
 * Api services for the `Award` model.
 */
@Injectable()
export class AwardApi extends BaseLoopBackApi {
   ...
   * This usually means the response is a `Award` object.)
   * </em>
   */
  ...
  /**
   * Fetches belongsTo relation companyService.
   *
   * @param {any} id Award id
   *
   * @param {any} nk Foreign key for photos.
   *
   ...
   * </em>
   */
  public getPhotosCompanyService(id: any, nk: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Awards/:id/photos/:nk/companyService";
    let _routeParams: any = {
      id: id,
      nk: nk
    };
