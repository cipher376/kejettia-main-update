...
export class MyUserApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public createProfile(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
   ...
   * This method returns no data.
   */
  public destroyProfile(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/profile";
    let _routeParams: any = {
  ...
  /**
   * Find a related item by id for fcmDevices.
   *
   * @param {any} id MyUser id
   *
   * @param {any} fk Foreign key for fcmDevices
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdFcmDevices(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/fcmDevices/:fk";
    let _routeParams: any = {
      id: id,
      fk: fk
    };
  ...
  /**
   * Delete a related item by id for fcmDevices.
   *
   * @param {any} id MyUser id
   *
   * @param {any} fk Foreign key for fcmDevices
   ...
   * This method returns no data.
   */
  public destroyByIdFcmDevices(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/fcmDevices/:fk";
    let _routeParams: any = {
  ...
  /**
   * Update a related item by id for fcmDevices.
   *
   * @param {any} id MyUser id
   *
   * @param {any} fk Foreign key for fcmDevices
   ...
   * </em>
   */
  public updateByIdFcmDevices(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/fcmDevices/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getFcmDevices(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/fcmDevices";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
  ...
  /**
   * Creates a new instance in fcmDevices of this model.
   *
   * @param {any} id MyUser id
   *
   * @param {object} data Request data.
   ...
   * </em>
   */
  public createFcmDevices(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/fcmDevices";
    let _routeParams: any = {
  ...
  /**
   * Deletes all fcmDevices of this model.
   *
   * @param {any} id MyUser id
   *
   * @returns {object} An empty reference that will be
   ...
   * This method returns no data.
   */
  public deleteFcmDevices(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/fcmDevices";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countFcmDevices(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/fcmDevices/count";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public verifyEmail(id: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/verifyEmail";
    let _routeParams: any = {
      id: id
    };
    let _postBody: any = {};
   ...
   * </em>
   */
  public createManyProfile(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/profile";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createManyFcmDevices(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/MyUsers/:id/fcmDevices";
    let _routeParams: any = {
